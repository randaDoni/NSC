<section class="py-2">
  <nav class="navbar navbar-expand-lg fixed-top shadow-sm" style="background-color: rgb(255, 255, 255)">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
            <input class="form-control  form-eduprixsearch-control rounded-pill" id="formGroupExampleInput" type="search" placeholder="Cari Berita" aria-label="Search" name="search">
