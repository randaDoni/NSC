               ...
               <div class="midde_cont">
                <div class="row column3"></div>
                    <div class="container-fluid">
                        <div class="card mt-5">
                              <div class="post-date m-3 col-12">18:11, Sunday, August 2, 2009 by Uploader</div>
                              <hr>
                              <center>
                                <div class="post-title">
                                    <h1><a href="#">BEASISWA PEMUDA INDONESIA</a></h1>
                                  </div>
                              <div class="card m-5 " style="width: 33rem;">
                                <a href="#"><img src="assets/img/logos/contoh-view.png" class="card-img-top" alt="..."></a>
                                <div class="card-header">
                                <caption>Pendaftaran: 29 Agustus - 28 September 2022</caption>
                                </div>
                            </div>
                        </center>
