            ...
            <div class="col-sm-6 besiswa1 col-lg-3 mb-4">
              <div class="card p-2 h-100">
                ...
                <div class="card-body px-0 py-3">
                  ...
                  <a class="ms-1 text-muted fs--1 stretched-link text-decoration-none" href="{{url('/luarNegeri')}}">Ikuti Informasi Beasiswa Luar Negeri</a>
                </div>
                <a class="text-decoration-none text-end mt-3 text-primary mb-2" href="{{url('/luarNegeri')}}" role="button">Read More
                  <svg class="bi bi-arrow-right text-primary ms-1 me-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                  </svg></a>
              </div>
